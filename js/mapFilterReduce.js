...
// // for - lus
// const animal_names_1 = [];
// for (const a of animals) {
//   animal_names_1.push(a.name);
// }
...
// // for - lus
// const small_animals_1 = [];
// for (const a of animals) {
//   if (a.size === 'small') {
//     small_animals_1.push(a);
//   }
// }
...
// // reduce
// const total_weight_2 = animals.reduce((result, value, index, array) => 
//   result += value.weight, 0);
// console.log(total_weight_2); // 5165

// // omdat er geen gebruik gemaakt wordt van index en array
// // had je dit ook als volgt kunnen schrijven
// const total_weight_3 = animals.reduce((result, value) => 
//   result += value.weight, 0);
...
// const total_weight_4 = animals.reduce((result, value) => 
//   result = value.name === 'elephant' ? result : result + value.weight, 0);
